...
Upgrade.init = function() {
	...
	for (var i = 0; i < shootRewardUpgrades.length; i++) {
		...
		$("#up-shoot-reward").append('<li id="up-shoot-reward-' + (i+1) + '" class="list-group-item cur-p"><b>' + cnItem(s.name) + ' </b>: ' + cnItem(s.desc) + ' - <i>成本 $' + fix(s.price, "money") + '</i></li>');
	...
	for (var i = 0; i < shootTimeUpgrades.length; i++) {
		...
		$("#up-shoot-time").append('<li id="up-shoot-time-' + (i+1) + '" class="list-group-item cur-p"><b>' + cnItem(s.name) + ' </b>: ' + cnItem(s.desc) + ' - <i>成本 $' + fix(s.price, "money") + '</i></li>');
	...
	for (var i = 0; i < ammoStockUpgrades.length; i++) {
		...
		$("#up-ammo-stock").append('<li id="up-ammo-stock-' + (i+1) + '" class="list-group-item cur-p"><b>' + cnItem(a.name) + ' </b>: ' + cnItem(a.desc) + ' - <i>成本 $' + fix(a.price, "money") + '</i></li>');
	...
	for (var i = 0; i < reloadTimeUpgrades.length; i++) {
		...
		$("#up-reload-time").append('<li id="up-reload-time-' + (i+1) + '" class="list-group-item cur-p"><b>' + cnItem(r.name) + ' </b>: ' + cnItem(r.desc) + ' - <i>成本 $' + fix(r.price, "money") + '</i></li>');
	...
	for (var i = 0; i < weedPriceUpgrades.length; i++) {
		...
		$("#up-weed-price").append('<li id="up-weed-price-' + (i+1) + '" class="list-group-item cur-p"><b>' + cnItem(w.name) + ' </b>: ' + cnItem(w.desc) + ' - <i>成本 $' + fix(w.price, "money") + '</i></li>');
	...
	for (var i = 0; i < methPriceUpgrades.length; i++) {
		...
		$("#up-meth-price").append('<li id="up-meth-price-' + (i+1) + '" class="list-group-item cur-p"><b>' + cnItem(m.name) + ' </b>: ' + cnItem(m.desc) + ' - <i>成本 $' + fix(m.price, "money") + '</i></li>');
	...
	for (var i = 0; i < cocainePriceUpgrades.length; i++) {
		...
		$("#up-cocaine-price").append('<li id="up-cocaine-price-' + (i+1) + '" class="list-group-item cur-p"><b>' + cnItem(c.name) + ' </b>: ' + cnItem(c.desc) + ' - <i>成本 $' + fix(c.price, "money") + '</i></li>');
...
Upgrade.saveCheck = function() {
	...
	for (var i = 0; i < shootRewardUpgrades.length; i++) {
		...
		if (shootRewardUpgradesOwned[i] == true) {
			...
			$("#up-shoot-reward-" + (i+1)).append('<span class="badge">已拥有</span>');
		};
	};
	for (var i = 0; i < shootTimeUpgrades.length; i++) {
		var s = shootTimeUpgrades[i];
		if (shootTimeUpgradesOwned[i] == true) {
			...
			$("#up-shoot-time-" + (i+1)).append('<span class="badge">已拥有</span>');
		};
	};
	for (var i = 0; i < ammoStockUpgrades.length; i++) {
		var a = ammoStockUpgrades[i];
		if (ammoStockUpgradesOwned[i] == true) {
			...
			$("#up-ammo-stock-" + (i+1)).append('<span class="badge">已拥有</span>');
		};
	};
	for (var i = 0; i < reloadTimeUpgrades.length; i++) {
		var r = reloadTimeUpgrades[i];
		if (reloadTimeUpgradesOwned[i] == true) {
			...
			$("#up-reload-time-" + (i+1)).append('<span class="badge">已拥有</span>');
		};
	};
	for (var i = 0; i < weedPriceUpgrades.length; i++) {
		var w = weedPriceUpgrades[i];
		if (weedPriceUpgradesOwned[i] == true) {
			...
			$("#up-weed-price-" + (i+1)).append('<span class="badge">已拥有</span>');
		};
	};
	for (var i = 0; i < methPriceUpgrades.length; i++) {
		var m = methPriceUpgrades[i];
		if (methPriceUpgradesOwned[i] == true) {
			...
			$("#up-meth-price-" + (i+1)).append('<span class="badge">已拥有</span>');
		};
	};
	for (var i = 0; i < cocainePriceUpgrades.length; i++) {
		var c = cocainePriceUpgrades[i];
		if (cocainePriceUpgradesOwned[i] == true) {
			...
			$("#up-cocaine-price-" + (i+1)).append('<span class="badge">已拥有</span>');
		};
	};
	Upgrade.hide();
};
Upgrade.buy = function(type, index) {
	if (type == 'shoot-reward' && money[0] >= shootRewardUpgrades[index].price) {
		...
		$("#up-shoot-reward-" + (index+1)).append('<span class="badge">已拥有</span>');
	};
	if (type == 'shoot-time' && money[0] >= shootTimeUpgrades[index].price) {
		...
		$("#up-shoot-time-" + (index+1)).append('<span class="badge">已拥有</span>');
	};
	if (type == 'ammo-stock' && money[0] >= ammoStockUpgrades[index].price) {
		...
		$("#up-ammo-stock-" + (index+1)).append('<span class="badge">已拥有</span>');
	};
	if (type == 'reload-time' && money[0] >= reloadTimeUpgrades[index].price) {
		...
		$("#up-reload-time-" + (index+1)).append('<span class="badge">已拥有</span>');
	};
	if (type == 'weed-price' && money[0] >= weedPriceUpgrades[index].price) {
		...
		$("#up-weed-price-" + (index+1)).append('<span class="badge">已拥有</span>');
	};
	if (type == 'meth-price' && money[0] >= methPriceUpgrades[index].price) {
		...
		$("#up-meth-price-" + (index+1)).append('<span class="badge">已拥有</span>');
	};
	if (type == 'cocaine-price' && money[0] >= cocainePriceUpgrades[index].price) {
		...
		$("#up-cocaine-price-" + (index+1)).append('<span class="badge">已拥有</span>');
	};
	Upgrade.hide();
};
