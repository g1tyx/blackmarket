...
Part.init = function() {
	for (var i = 0; i < parts.length; i++) {
		...
		$("#factory-parts-table-tr-" + (i+1)).append('<td id="factory-parts-table-name-' + (i+1) + '">' + cnItem(parts[i].name) + '</td>');
		...
		$("#factory-parts-table-tr-" + (i+1)).append('<td id="factory-parts-table-craft-' + (i+1) + '">' + '<a id="factory-parts-btn-' + (i+1) + '" class="btn btn-success btn-sm center-block" onclick="Part.craft(' + i + ');">制作</a>' + '</td>');
	};
};
...
Gun.init = function() {
	for (var i = 0; i < guns.length; i++) {
		...
		$("#factory-guns-table-tr-" + (i+1)).append('<td id="factory-guns-table-craft-' + (i+1) + '">' + '<a id="factory-guns-btn-' + (i+1) + '" class="btn btn-success btn-sm center-block" onclick="Gun.craft(' + i + ');">制作</a>' + '</td>');
	};
};
